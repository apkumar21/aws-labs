...
```bash
hello-app$ pip install -r tests/requirements.txt --user
# unit test
hello-app$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
hello-app$ AWS_SAM_STACK_NAME="hello-app" python -m pytest tests/integration -v
```
...
```bash
sam delete --stack-name "hello-app"
```
